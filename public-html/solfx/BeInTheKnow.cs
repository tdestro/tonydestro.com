...
public class inquiryEvent : Page {
	...
	{
		string query = "";
		query = query +Request.QueryString["comment"];
		if(Request.QueryString["comment"] == "shield"){
			txtComments.Text="I'm interested in SHIELD products.";
		}
	}
	...
	private void SaveXMLData() {
		...
		XmlText cityText = xmldoc.CreateTextNode(txtCity.Text);
