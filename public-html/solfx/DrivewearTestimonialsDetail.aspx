...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="DrivewearTestimonialsDetail">
	<!--#include file="_incl/GlobalHeader.aspx"-->
	<div id="wrapper">
	<div id="ajaxContainer">
       <div id="content" class="TestimonialsDetail">
       		<div id="drivewearNav">
				<ul>
			...
			<div id="testimonialBtns">
            	<div class="testimonial" id="calvinScaff">
                ...
                <div class="testimonial" id="colleenHoaulfuss">
                	<img src="images/testimonials/DetailColleenHoaulfuss.jpg" alt="John Doe" />
                ...
                <div class="testimonial" id="howardGoyer">
                ...
                <div class="testimonial" id="cyndiWideman">
                ...
                <div class="testimonial" id="mikeMerrich">
                ...
                <div class="testimonial" id="joeBonchard">
                ...
                <div class="testimonial" id="natalieEddy">
                	<img src="images/testimonials/DetailNatalieEddy.jpg" alt="Natalie Eddy" />
                    	...
                    	<strong>"Comfortable Outside and Inside"</strong>
                    	<br/><br/>
                ...
                <div class="testimonial" id="sterlingEpps">
                ...
                <div class="testimonial" id="nguyetDao">
                ...
                <div class="testimonial" id="jimSanchez">
                ...
                <div class="testimonial" id="jayArroyo">
