       ...
       <div id="content" class="dwProductDemo">
            ...
            <div id="demoArea">
            	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="960" height="485" title="Drivewear Demo">
					<param name="movie" value="Flash/carStandalone.swf" />
					<param name="quality" value="high" />
					<param name="wmode" value="transparent" />
					<embed src="Flash/carStandalone.swf" quality="high" wmode="transparent" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="960" height="485"></embed>
				</object>
            </div>
        </div>
	</div>
