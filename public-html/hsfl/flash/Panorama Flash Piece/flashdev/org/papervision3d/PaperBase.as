package org.papervision3d {
	...
	public class PaperBase extends Sprite { //Must be "extends Sprite"
	   ...
	   public var current_camera:Camera3D;
	   public var current_viewport:Viewport3D;
	   public var p:*;
	   public var videoLock:Boolean=false;	   

	   public function init(vpWidth:Number = 960, vpHeight:Number = 540):void {
	   ...
	   protected function initPapervision(vpWidth:Number, vpHeight:Number):void {
		 ...
		 viewport.cullingRectangle = new Rectangle(0, 0, 960, 540);
	   ...
	   protected function initEvents():void {
		 ...
		 // every frame.
		 addEventListener(Event.ENTER_FRAME, pbEnterFrame);
	   ...
	   protected function pbEnterFrame( ThisEvent:Event ):void {
		 //We need to render the scene and update anything here.
		 processFrame();
		 renderer.renderScene(current_scene, default_camera, viewport);
	   }
	}
}